...
while(userChoice != "8"){
  ...
  if(userChoice == "1"){
    ...
    console.log(getEmail(index));
    // The getEmail function is called with the given index and the returned Email object is logged to the console
